...
public class MaterialMap {
	 ...
	 * <p/>
	 * private int getKey(MaterialData md) throws NullPointerException { return
	 * getKey(md.getItemTypeId(), md.getData()); }
	 * <p/>
	 * private int getKey(int id, byte data) { return ((id << 8) | data); }
	 * <p/>
	 * private int getData(int key) { return (short) (key & 0xffff); }
	 * <p/>
	 * private int getId(int key) { return ((key >> 8) & 0xffff); }
	 * <p/>
	 * private MaterialData getMaterialData(int key) { return new
	 * MaterialData(getId(key), (byte) getData(key)); }
	 */
